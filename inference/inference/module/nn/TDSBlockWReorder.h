...
// Copy of TDSBlock with added Reorder before and after.
// Implemented as separate class to not to break serialization.
class TDSBlockWReorder : public Sequential {
 public:
  explicit TDSBlockWReorder(
  ...
  virtual ~TDSBlockWReorder() override = default;
 ...
 private:
  ...
  TDSBlockWReorder(); // Used by Cereal for serialization.
...
CEREAL_REGISTER_TYPE(w2l::streaming::TDSBlockWReorder);
